...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Set up shared qwen-asr for Bili Note.")
    parser.add_argument("--venv", type=Path, default=default_venv())
    parser.add_argument("--python", default=sys.executable, help="Python executable for venv.")
    ...
    run([str(py), "-m", "pip", "install", "qwen-asr", "accelerate"], args.dry_run)
    return 0
